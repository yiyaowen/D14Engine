...
namespace d14engine::ui
{
    ...
    Optional<Wstring> UIResourceUtils::GetClipboardText(HWND hWndNewOwner)
    {
    ...
    void UIResourceUtils::SetClipboardText(WstrViewParam content, HWND hWndNewOwner)
    {
        if (IsClipboardFormatAvailable(CF_UNICODETEXT) && OpenClipboard(hWndNewOwner))
        {
    ...
    UIResourceUtils::KeyboardLayoutMap UIResourceUtils::US_KEYBOARD_LAYOUT =
    {
        // Alphabet
        { 0x41, { L'a', L'A' } },
        { 0x42, { L'b', L'B' } },
