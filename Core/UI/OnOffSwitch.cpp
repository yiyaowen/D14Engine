...
namespace d14engine::ui
{
    ...
    void OnOffSwitch::OnRendererDrawD2D1ObjectHelper(Renderer* rndr)
    {
        ...
        UIResu::SOLID_COLOR_BRUSH->SetColor(handleSettingPtr->color);
        UIResu::SOLID_COLOR_BRUSH->SetOpacity(handleSettingPtr->opacity);

        rndr->d2d1DeviceContext->FillRoundedRectangle(
            { handleRect, handleSettingPtr->roundRadius, handleSettingPtr->roundRadius }, UIResu::SOLID_COLOR_BRUSH.Get());
    }
